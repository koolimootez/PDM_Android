...
import com.example.projetresqeats.databinding.OtpValidationBinding
...
class OtpValidationActivity : AppCompatActivity() {
    ...
    private lateinit var binding: OtpValidationBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = OtpValidationBinding.inflate(layoutInflater)
